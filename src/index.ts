import { advancedArmyCreator } from "./creators/armyCreator";
...
english.addArmy(advancedArmyCreator(english.getType()));
const byzantine = civilizationCreator(CivilizationTypesEnum.byzantine);
byzantine.addArmy(advancedArmyCreator(byzantine.getType()));
